...
import { CREATE_COMMENT, LIKE_TARGET_BOARD_ARTICLE_BY_BOARD_NAME, UPDATE_COMMENT } from '../../apollo/user/mutation';
...
const CommunityDetail: NextPage = ({ initialInput, ...props }: T) => {
	...
	/** APOLLO REQUESTS **/
	const [likeTargetBoardArticle] = useMutation(LIKE_TARGET_BOARD_ARTICLE_BY_BOARD_NAME);
